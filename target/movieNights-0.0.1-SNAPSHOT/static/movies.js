...
//SEARCH BOX
    ...
    $(".genres").on("click", function () {
        ...
        if ($(".active").attr("id") === "popular") {
          var  URL = "https://api.themoviedb.org/3/discover/movie?api_key=e58e3961f5be7e510894dc736fee6937&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=" + genre + "&page=1&vote_count.gte=200";
