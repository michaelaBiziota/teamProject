...
function Load($) {
    ...
    $("#button").on("click", function () {
        ...
        if (results.length === 0) {
            $("#text").html("In order to provide you with the very best recommendations we need to know you better!<br>Go back to exploring and show us at least "+(5 -favouriteArray.length)+" more of your absolutely favourite movies!");
        }else{
