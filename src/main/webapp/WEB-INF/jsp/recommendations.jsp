        ...
        <div class="container">
            ...
            <div id="text" class="par">
                <p>Many apps offer recommendations but usually fail to provide good ones.<br>
                    We decided to focus on great browsing experience that makes it easy to quickly find a movie you'll enjoy watching.<br>
                    Our recommendations are based on your preferences, so if you haven't done any exploring go back and do so!<br>  
                </p>
            </div>
        </div>
        <div class="container">
